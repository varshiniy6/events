...
- The `Events` component is provided with `eventsList`. It consists of a list of eachItem objects with the following properties in each eventItem object
...
- Image of each event item should have alt attribute value as **event**
...
url : https://eventsvreg.ccbp.tech
